...
execute unless data storage datapipes_lib:temp slot run return run function datapipes_lib:item_transfer/remove_items/as_slot with storage datapipes_lib:temp args
...
#run with slot args
function datapipes_lib:item_transfer/remove_items/args with storage datapipes_lib:temp slot

#continue onto next slot
function datapipes_lib:item_transfer/remove_items/as_slot with storage datapipes_lib:temp args