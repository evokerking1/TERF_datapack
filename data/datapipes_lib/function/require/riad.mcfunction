...
function datapipes_lib:require/run_with_angle_relative with storage datapipes_lib:temp args

execute if score runin360degrees datapipes_lib matches ..359999 run function datapipes_lib:require/riad