...
execute on target run tellraw @s ["[",{"text":"Electron Bomb","color":"gold"},"] ",{"text":"Detonating in ","color":"dark_red"},{"score":{"objective":"terf_states","name":"temp"},"color":"red"},{"text":"s...","color":"dark_red"}]
