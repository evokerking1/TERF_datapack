playsound minecraft:entity.zombie_villager.converted player @a[distance=0..] ~ ~ ~ 0.7 2

data modify storage terf:temp args set value {command:'particle minecraft:ominous_spawning ^ ^ ^5 ^ ^ ^-50000000000 0.0000000001 0 force'}
