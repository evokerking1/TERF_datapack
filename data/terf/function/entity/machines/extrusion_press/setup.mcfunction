data modify entity @s data.terf.multiblock_function set value 'run function terf:entity/machines/extrusion_press/tick'
...
scoreboard players set @s datapipes_lib_power_max 800
