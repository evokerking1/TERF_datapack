...
scoreboard players set @s datapipes_lib_power_max 1500
...
data modify entity @s data.fluids append value {max:1000,amount:0,id:"water",changetype:"",outpos:"^ ^ ^-1",checks:"positioned ^ ^ ^-1 if function terf:require/observer_fluid_checks"}
data modify entity @s data.fluids append value {max:1000,amount:0,id:"terf.hydrogen",outpos:"^1 ^ ^1",checks:"positioned ^1 ^ ^1 if function terf:require/observer_fluid_checks",pipe_on:'function terf:require/observer_output {cmd:"datapipes_lib:require/pipe_presets/lightning_rod/pipes_on"}',pipe_off:'function terf:require/observer_output {cmd:"datapipes_lib:require/pipe_presets/lightning_rod/pipes_off"}'}
data modify entity @s data.fluids append value {max:1000,amount:0,id:"terf.oxygen",outpos:"^-1 ^ ^1",checks:"positioned ^-1 ^ ^1 if function terf:require/observer_fluid_checks",pipe_on:'function terf:require/observer_output {cmd:"datapipes_lib:require/pipe_presets/lightning_rod/pipes_on"}',pipe_off:'function terf:require/observer_output {cmd:"datapipes_lib:require/pipe_presets/lightning_rod/pipes_off"}'}
