...
#sound
data modify storage terf:temp args set value {arg1:'execute as @a[distance=',arg3:'..',arg5:'] run function terf:entity/explosion/small_explosion/reach_player'}
...
scoreboard players set temp2 terf_states 40
...
execute if score @s terf_data_A matches 40.. run kill @s
