...
#sound
data modify storage terf:temp args set value {arg1:'execute as @a[distance=',arg3:'..',arg5:'] run function terf:entity/explosion/nuclear/reach_player'}
...
execute if score @s terf_data_A matches 1000.. run function terf:entity/explosion/nuclear/stop

#destruction
function terf:entity/explosion/nuclear/upcast

particle minecraft:explosion ~ ~ ~ 5 5 5 30 10 force
