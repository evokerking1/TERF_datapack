execute if block ~ ~ ~ #minecraft:air rotated ~ ~-0.06 positioned ^ ^ ^1 run return run function terf:entity/explosion/nuclear/raycast
execute if block ~ ~ ~ #terf:explosion_destroy_3 rotated ~ ~-0.06 positioned ^ ^ ^1 run function terf:entity/explosion/nuclear/raycast
